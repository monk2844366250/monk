...
export default {
  ...
  methods: {
    ...
    creatData() {
      ...
      console.log('taskGoodsListData', taskGoodsListData)
      // taskCommentListData
      var taskCommentListData = goodsdatas.postData.taskCommentList
      console.log('taskGoodsListData', taskCommentListData)
      // taskAdditionalIncrement
      var taskAdditionalIncrementData = goodsdatas.postData.taskAdditionalIncrement
      console.log('taskGoodsListData', taskAdditionalIncrementData)
      // //  第一部分再次渲染  商品主图部分
      ...
      // // 第四部分
      console.log('第四部分渲染', goodsdatas.postData.screenshotDetailIds)
      ...
      // // 第五部分
      console.log('第五部分渲染', taskAdditionalIncrementData)
      ...
      // this.form.taskAdditionalIncrement.sex = taskAdditionalIncrementData.minAge
