  ...
  <div class="form">
    ...
    <div v-for="item in addShop">
      ...
      <div class="form-item" style="margin-top: 35px">
        ...
        <el-input v-model="form.taskGoodsList[item-1].showPrice" size="mini" type="number" style="width: 140px" :min="0">
    ...
    <div class="form-item">
      ...
      <el-input
        v-model="form.searchMinPrice"
        size="mini"
        :min="0"
        :max="form.searchMaxPrice"
        type="number"
        style="width: 130px"
        @blur="inputBlurNumber"
      >
        <template slot="append">元</template>
      </el-input>
      <span style="color:#6666FF;width: 20px;font-size: 12px;text-align: center;">一</span>
      <el-input
        v-model="form.searchMaxPrice"
        size="mini"
        :min="form.searchMinPrice"
        type="number"
        style="width: 130px"
        @change="inputBlurNumberLu"
      >
        <template slot="append">元</template>
      </el-input>
    </div>
    ...
    <div v-for="(item, index) in addtkl" v-if="form.searchType===2" :key="index" class="form-item">
      <span class="form-required">*必填</span>
