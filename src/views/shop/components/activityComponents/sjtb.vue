  ...
  <div class="form">
    ...
    <div v-for="item in addShop">
      ...
      <div class="form-item" style="margin-top: 35px">
        ...
        <el-input v-model="form.taskGoodsList[item-1].showPrice" size="mini" style="width: 140px" type="number">
...
export default {
  ...
  created() {
    ...
    console.log('生成', this.form.storeId, this.form.storeTypeId, this.form.taskTypeId)
  ...
  methods: {
    ...
    init() {
      ...
      selectYwTaskScreenshotCategoryList({ taskTypeId: this.taskType }).then(response => {
        ...
        console.log('this.imgList', this.taskType)
      })
    ...
    handleAddGood() {
      ...
      console.log('到底数据哪里有问题', this.form.taskGoodsList, this.form.taskGoodsList.showPrice)
    },
