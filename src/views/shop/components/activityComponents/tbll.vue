...
export default {
  ...
  methods: {
    ...
    handleNext() {
      ...
      console.log('taskCommentList', this.form.taskCommentList)// 空
      console.log('data.taskCommentList1234', data.taskCommentList)// 空
      ...
      //     console.log('order', this.order1[i])
      //   // for (let j = 0; j < this.order1[i] - 1; j++) {
      //     taskArr.push(JSON.parse(JSON.stringify(this.form.taskCommentList[i])))
