    ...
    <div class="form">
      ...
      <div v-for="item in addpjzp" v-if="form.appendCommentType === 3">
        ...
        <div class="form-item">
          <span class="form-required" />
          <span class="form-label">评语：</span>
          <el-input v-model="zptpList[item-1].appendContent" size="small" style="width: 350px" placeholder="" />
      ...
      <div v-for="item in addpjzp" v-if="form.appendCommentType===4">
        ...
        <div class="form-item">
          <span class="form-required" />
          <span class="form-label">评语：</span>
          <el-input v-model="zpspList[item-1].appendContent" size="small" style="width: 350px" placeholder="" />
...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      console.log('地址位置的数据', idData, numStore)
