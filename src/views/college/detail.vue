<template>
  <div class="college-contain">
    ...
    <div class="like">
      ...
      <el-backtop />
      <!-- </el-button> -->
      <el-button v-re-click type="text" @click="handleAddYwArticlePraise">
        <div class="like-icon">
    ...
    <div class="comment">
      ...
      <div class="comment-input">
        <el-input v-model="content" type="textarea" :autosize="{ minRows: 4}" placeholder="请输入评论内容" />
        <el-button
          v-re-click
          type="primary"
      ...
      <div v-loading="listLoading" class="comment-list">
        <div v-for="item in commentList">
          <el-row :gutter="20">
            <el-col :span="2">
              <el-avatar :size="50" :src="item.avatar" style="margin-left: 20px" />
            </el-col>
            <el-col :span="20">
              <div>
